...
from vec_transformer_agent import (
    VECTransformerAgent, 
    get_state_size, 
    flatten_observation,
...
def main():
    """Main function to run VEC transformer experiments"""
    parser = argparse.ArgumentParser(description='Run VEC transformer experiments')
