...
def train_dqn(env_config, agent_config, log_dir="results"):
    ...
    env = VECEnvironment(
        ...
        energy_csv_path=env_config.get('energy_csv_path'),  # Added energy_csv_path
        energy_weight=env_config.get('energy_weight', 0.5),  # Added energy_weight with default
    ...
    drop_rates = []
    avg_latencies = []
    energy_consumptions = []  # Added tracking for energy consumption
    ...
    for episode in range(1, num_episodes + 1):
        ...
        episode_reward = 0
        step = 0
        total_energy = 0  # Track energy consumption per episode
    ...
    metrics = {
        ...
        'energy_consumptions': energy_consumptions  # Added energy consumption metrics
    }
...
def plot_training_curves(metrics, save_dir):
    """Plot and save training curves"""
    plt.figure(figsize=(20, 15))  # Increased size for additional plot
...
if __name__ == "__main__":
    ...
    env_config = {
        ...
        'max_queue_length': 50,
        'history_length': 10,
        'energy_csv_path': args.energy_csv_path,  # Added energy_csv_path
        'energy_weight': args.energy_weight,      # Added energy_weight
        'seed': args.seed
    }
